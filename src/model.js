...
import {TextColumnsBlock, TextBlock, TitleBlock, ImageBlock} from './classes/block'
...
export const model = [
  ...
  new TextBlock(text, {styles: 'background: linear-gradient(to left, #f2994a, #f2c94c);font-weight: bold;padding: 1rem;'}),
  new TextColumnsBlock([
    'Приложение на чистом JavaScript, без использования библиотек',
    'Принципы SOLID и ООП в JavaScript за один курс',
